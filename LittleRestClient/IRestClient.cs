...
namespace LittleRestClient
{
    public interface IRestClient
    {
        ...
        Task<RestClientResponse<TResult>> GetAsync<TResult>(string route);
        /// <summary>
        ...
        /// <returns>Task<RestClientResponse<TResult>></returns>
        Task<RestClientResponse<TResult>> PostAsync<TBody, TResult>(string route, TBody body);
        /// <summary>
        ...
        Task<RestClientResponse> PostAsync<TBody>(string route, TBody body);
        /// <summary>
        ...
        /// <param name="body">the payload you want to send</param>
        /// <returns>Task<RestClientResponse<TResult>></returns>
        Task<RestClientResponse<TResult>> PutAsync<TBody, TResult>(string route, TBody body);
        /// <summary>
        ...
        /// <param name="body">the payload you want to send</param>
        /// <returns>Task<RestClientResponse></returns>
        Task<RestClientResponse> PutAsync<TBody>(string route, TBody body);
        /// <summary>
        ...
        /// <param name="body">the payload you want to send</param>
        /// <returns>Task<RestClientResponse<TResult>></returns>
        Task<RestClientResponse<TResult>> PatchAsync<TBody, TResult>(string route, TBody body);
        /// <summary>
        ...
        /// <param name="body">the payload you want to send</param>
        /// <returns>Task<RestClientResponse></returns>
        Task<RestClientResponse> PatchAsync<TBody>(string route, TBody body);
        /// <summary>
        ...
        /// <param name="route">The route for the endpoint you want to hit</param>
        /// <returns>Task<RestClientResponse<TResult>></returns>
        Task<RestClientResponse<TResult>> DeleteAsync<TResult>(string route);
        /// <summary>
        /// Does a DELETE and only expects a status in response
        /// </summary>
        /// <param name="route">The route for the endpoint you want to hit</param>
        /// <returns>Task<RestClientResponse></returns>
        Task<RestClientResponse> DeleteAsync(string route);
        /// <summary>
        /// Disposes
        /// </summary>
        void Dispose();
