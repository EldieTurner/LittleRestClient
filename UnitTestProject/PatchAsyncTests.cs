...
public class PatchAsyncTests
{
    ...
    [TestMethod]
    public async Task PatchAsync_Happy_Test()
    {
        // Arrange
        ...
        // Act
        var response = await _restClient.PatchAsync<SimpleTestObject, SimpleTestObject>("TestRoute", requestObject);
    ...
    [TestMethod]
    public async Task PatchAsync_NotFound_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
    ...
    [TestMethod]
    public async Task PatchAsync_ServerError_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
    ...
    [TestMethod]
    public async Task PatchAsync_EmptyResponse_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
    ...
    [TestMethod]
    public async Task PatchAsync_NoResult_Happy_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
        ...
        // Act
        var response = await _restClient.PatchAsync("TestRoute", requestObject);
    ...
    [TestMethod]
    public async Task PatchAsync_NoResult_NotFound_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
    ...
    [TestMethod]
    public async Task PatchAsync_NoResult_ServerError_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
    ...
    [TestMethod]
    public async Task PatchAsync_NoResult_EmptyResponse_Test()
    {
        // Arrange
        var requestObject = new SimpleTestObject { TestProperty = "Request Value", TestProperty2 = 1 };
